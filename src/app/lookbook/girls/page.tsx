...
export default function LookbookPage() {
    const lookbookImages = [
        getPlaceholderImage('child-romper'),
    ...
    <div className="bg-background">
      <div className="container py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight">Girls' Lookbook</h1>
          <p className="mt-6 text-lg md:text-xl">
            Find inspiration in our curated looks for girls, telling the story of family in every thread.
          </p>
        </div>
